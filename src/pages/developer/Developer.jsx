        ...
        {links.map((link) => (
          ...
          >
            <div className="w-10 h-10 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg flex items-center justify-center shrink-0">
              {React.createElement(link.icon, { className: 'w-5 h-5 text-indigo-600 dark:text-indigo-400' })}
            </div>
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-indigo-600 dark:text-indigo-400 truncate mt-0.5">{link.url}</p>
            </div>
